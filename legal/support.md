...
- **Working offline.** The app works fully without a connection; changes sync automatically once
  you're back online.
- **Exporting your data.** Settings → Account → Export my data saves a JSON copy of your account
  and training data.
- **Deleting your account.** Settings → Account → Delete account removes your account and all its
  data immediately. If you no longer have the app, request deletion here:
  <https://willdodds7-arch.github.io/wildodds-gymtracker/account-deletion.html>
- **Usage statistics.** Sharing anonymous usage statistics is optional and off unless you turn it
  on; change it anytime in Settings → Account.
